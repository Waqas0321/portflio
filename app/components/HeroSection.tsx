				...
				<div className="text-center mb-8">
					<div className="flex justify-center mb-6">
						<div className="relative group">
							<div className="absolute inset-0 rounded-full bg-gradient-to-tr from-blue-400 via-purple-500 to-pink-400 p-1 animate-spin-slow group-hover:scale-105 transition-transform duration-300" style={{ filter: 'blur(2px)' }}></div>
							<Image src="/profile.jpg" alt="Profile" width={144} height={144} className="w-36 h-36 rounded-full border-4 border-white shadow-2xl object-cover relative z-10 group-hover:scale-105 transition-transform duration-300" />
							<div className="absolute inset-0 rounded-full border-4 border-white z-0"></div>
						</div>
					</div>
					...
					<p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed px-4">
						Flutter developer with a strong focus on building scalable, high-quality mobile apps. Experienced across the full app lifecycle from idea to launch. Passionate about clean code, great UX, and continuous growth. Eager to contribute to impactful projects and take on new challenges.
					</p>
				</div>
