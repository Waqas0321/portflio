...
const specializedSkills: Skill[] = [
	{ name: 'State Management (GetX, Bloc, Provider)', level: 90 },
		...
		<section className="py-16 md:py-20 relative">
			<div className="container mx-auto px-4">
				...
				<p className="text-sm sm:text-base text-gray-400 text-center mb-8 sm:mb-12 max-w-2xl mx-auto px-4">
					Programming: <span className="text-blue-400">DART, C++, Flutter</span><br />
					Tools: <span className="text-purple-400">Android Studio, VS Code, Git & GitHub, Firebase, Postman</span>
				</p>

				<div className="flex flex-col gap-8 sm:gap-12 max-w-3xl mx-auto items-stretch">
					{/* Core Skills */}
					<div className="space-y-4 sm:space-y-6 px-2 bg-gray-800/40 rounded-2xl shadow-lg p-6">
						<h3 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6 flex items-center gap-2 text-blue-400">
					...
					{/* Specialized Skills */}
					<div className="space-y-4 sm:space-y-6 px-2 bg-gray-800/40 rounded-2xl shadow-lg p-6">
						<h3 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6 flex items-center gap-2 text-purple-400">
