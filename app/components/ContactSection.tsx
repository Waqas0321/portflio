			...
			<div className="max-w-4xl mx-auto">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center space-y-8">
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:waqasakhtar548@gmail.com"
...
>
  ...
  WhatsApp Me
					...
					<div className="flex justify-center gap-6">
						<a
							href="https://github.com/Waqas0321"
							target="_blank"
							rel="noopener noreferrer"
						...
						<a
							href="https://www.linkedin.com/in/m-waqas-akhtar-545155276"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-full"
						>
						...
						<a
							href="https://x.com/WaqasAkhtar001?s=09"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-full"
						>
